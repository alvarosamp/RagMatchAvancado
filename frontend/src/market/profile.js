...
export const MARKET_PROFILES = {
  public_procurement: {
    ...
    nav: {
      dashboard: { label: 'Inicio', hint: 'Proximas acoes' },
      suite: { label: 'Modulos', hint: 'Visao do produto' },
      pncp_monitor: { label: 'Monitoramento', hint: 'Filtros e alertas' },
      upload: { label: 'Enviar edital', hint: 'PDF ou JSON' },
      radar: { label: 'Buscar oportunidades', hint: 'Editais monitorados' },
      ...
      crm: { label: 'CRM', hint: 'Funil comercial' },
      ...
      analysis_dashboard: { label: 'Analises', hint: 'Itens e categorias' },
      ...
      settings: { label: 'Configuracoes', hint: 'Preferencias' },
  ...
  generic_matching: {
    ...
    nav: {
      ...
      radar: { label: 'Buscar oportunidades', hint: 'Oportunidades monitoradas' },

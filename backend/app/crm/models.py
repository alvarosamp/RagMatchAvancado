...
class CrmNotice(Base):
    ...
    analysis_document_id = Column(Integer, ForeignKey("analysis_documents.id", ondelete="SET NULL"), index=True)
    ...
    uasg = Column(String)
    state = Column(String)
    proposal_validity = Column(String)
    document_delivery_moment = Column(String)
    analysis_status = Column(String)
    analysis_mode = Column(String)
    analysis_confidence = Column(String)
    decision_recommendation = Column(String)
    decision_score = Column(Integer)
    decision_risk_score = Column(Integer)
    decision_intelligence = Column(JSON)
    bi_item_summary = Column(Text)
    bi_criterion = Column(String)
    bi_interval = Column(String)
    bi_exclusivity = Column(String)
...
class CrmNoticeProduct(Base):
    ...
    category = Column(String)
    technical_characteristics = Column(Text)
    risk_associated = Column(Text)
    brand_direction_exists = Column(Boolean)
    brand_direction_model = Column(String)
    brand_direction_type = Column(String)
    brand_direction_justification = Column(Text)
    bi_features = Column(JSON)
    bi_feature_quantidade_portas = Column(String)
    bi_feature_portas_acesso = Column(String)
    bi_feature_gerenciamento = Column(String)
    bi_feature_alimentacao_poe = Column(String)
    bi_feature_uplinks = Column(String)
    bi_feature_camada = Column(String)
    bi_feature_tecnologia_wifi = Column(String)
    bi_feature_alimentacao = Column(String)
    bi_feature_ambiente = Column(String)
    bi_feature_formato = Column(String)
    bi_feature_velocidade = Column(String)
    bi_feature_tipo_meio = Column(String)
    bi_feature_alcance = Column(String)
